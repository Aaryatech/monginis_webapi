...
public class GetInTrays {
	...
	public String toString() {
		return "GetInTrays [intrayId=" + intrayId + ", frId=" + frId + ", outtrayBig=" + outtrayBig + ", outtraySmall="
				+ outtraySmall + ", outtrayLead=" + outtrayLead + ", outtrayDate=" + outtrayDate + ", intrayBig="
				+ intrayBig + ", intraySmall=" + intraySmall + ", intrayLead=" + intrayLead + ", balanceBig="
				+ balanceBig + ", balanceSmall=" + balanceSmall + ", balanceLead=" + balanceLead + ", frName=" + frName
				+ ", frCode=" + frCode + "]";
	}
