...
@Entity
public class GetCustomerBillNew {
	...
	public String toString() {
		return "GetCustomerBillNew [sellBillDetailNo=" + sellBillDetailNo + ", sellBillNo=" + sellBillNo
				+ ", invoiceNo=" + invoiceNo + ", billDate=" + billDate + ", frId=" + frId + ", frName=" + frName
				+ ", frMob=" + frMob + ", frAddress=" + frAddress + ", custName=" + custName + ", itemId=" + itemId
				...
				+ igstRs + ", cgstRs=" + cgstRs + ", sgstRs=" + sgstRs + ", itemHsncd=" + itemHsncd + ", intBillAmt="
				+ intBillAmt + ", intDiscAmt=" + intDiscAmt + "]";
	}
