...
import com.ats.webapi.repository.dashboard.FrPurchaseDashRepo;
...
public class DashBoardReporApi {
	...
	@Autowired
	FrPurchaseDashRepo frPurchaseDashRepo;
	...
	@RequestMapping(value = { "/getFrPurchaseReport" }, method = RequestMethod.POST)
