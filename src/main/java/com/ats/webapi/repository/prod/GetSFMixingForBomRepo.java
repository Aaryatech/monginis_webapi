...
/*	 old query
	...
	@Query(value=" SELECT m_item_sf_detail.sf_id, m_item_sf_detail.sf_did, m_item_sf_detail.rm_id,"
			...
			+ "m_rm_uom.uom, SUM(t_mixing_detail.received_qty* m_item_sf_detail.rm_qty *m_item_sf_detail.rm_weight)"
			+ " AS total from m_item_sf_detail, t_mixing_detail,m_rm_uom "
			+ "WHERE t_mixing_detail.sf_id=m_item_sf_detail.sf_id AND m_item_sf_detail.rm_type=1 "
