...
public interface SpCakeForProdAppRepo extends JpaRepository<GetSpCakeOrderForProdApp, Integer> {
	...
	List<GetSpCakeOrderForProdApp> getSpCakeOrderForProdGen(@Param("fromDate") String fromDate, @Param("toDate") String toDate,
			@Param("menuIdList") List<Integer> menuIdList, @Param("isSlotUsed") List<Integer> isSlotUsed); //C] specific menu no order by 
	...
	List<GetSpCakeOrderForProdApp> getSpCakeOrderForProdGenAllMenu(@Param("fromDate") String fromDate,
			@Param("toDate") String toDate, @Param("isSlotUsed") List<Integer> isSlotUsed);//A onload all menu no order by 
	...
	List<GetSpCakeOrderForProdApp> getSpCakeOrderByRouteIdSpecMenu(@Param("fromDate") String fromDate,
			@Param("toDate") String toDate, @Param("menuIdList") List<Integer> menuIdList,@Param("routeId") int routeId);// specific menu order by
