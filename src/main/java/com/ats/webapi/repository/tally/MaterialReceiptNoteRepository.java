...
public interface MaterialReceiptNoteRepository extends JpaRepository<MaterialReceiptNote, Integer>{
	...
	@Query(value="select\n" + 
			...
			"			d.other1 AS extra_disc_amt_on_item,\n" + 
			"			d.other2 AS extra_disc_amt_on_bill,\n" + 
			"			d.other3 AS extra_charges_on_item,\n" + 
			"			d.other4 AS extra_charges_on_bill,\n" + 
			"			d.amount,\n" + 
			"			 h.other1 AS  total_extra_disc_amt_on_item,\n" + 
			"			h.other2 AS total_extra_disc_amt_on_bill,\n" + 
			"			h.other3 AS total_extra_charges_on_item,\n" + 
			"			h.other4 AS  total_extra_charges_on_bill,\n" + 
			"			h.cgst,\n" + 
			"			h.sgst,\n" + 
			"			h.igst,\n" + 
			"			h.cess,\n" + 
