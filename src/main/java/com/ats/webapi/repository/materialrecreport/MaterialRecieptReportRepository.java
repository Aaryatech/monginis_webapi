...
public interface MaterialRecieptReportRepository extends JpaRepository<GetMaterialRecieptReportBillWise,Long>{
	...
	@Query(value="select t_material_receipt_note.mrn_id, t_material_receipt_note.mrn_no,  t_material_receipt_note.inv_book_date,\r\n" + 
			...
			" m_supplier.supp_city, m_supplier.supp_gstin, t_material_receipt_note.basic_value, t_material_receipt_note.disc_amt+t_material_receipt_note.disc_amt2 as disc_amt,\r\n" + 
			" t_material_receipt_note.freight_amt, t_material_receipt_note.insurance_amt, t_material_receipt_note.cgst, t_material_receipt_note.sgst,\r\n" + 
			" t_material_receipt_note.igst, t_material_receipt_note.round_off, t_material_receipt_note.bill_amount from\r\n" + 
			" t_material_receipt_note, m_supplier where\r\n" + 
			" t_material_receipt_note.supplier_id in (:suppId) and m_supplier.supp_id=t_material_receipt_note.supplier_id and "
			+ "t_material_receipt_note.inv_book_date between :fromDate and :toDate and t_material_receipt_note.status=5\r\n" + 
			" order by t_material_receipt_note.inv_book_date",nativeQuery=true)
	...
	@Query(value="select t_material_receipt_note.mrn_id, t_material_receipt_note.mrn_no, t_material_receipt_note.inv_book_date, t_material_receipt_note.invoice_number,\r\n" + 
			...
			" sum(t_material_receipt_note.basic_value) as basic_value, sum(t_material_receipt_note.disc_amt+t_material_receipt_note.disc_amt2) as disc_amt,\r\n" + 
			" sum(t_material_receipt_note.freight_amt) as freight_amt, sum(t_material_receipt_note.insurance_amt) as insurance_amt,\r\n" + 
			" sum(t_material_receipt_note.cgst) as cgst, sum(t_material_receipt_note.sgst) as sgst, sum(t_material_receipt_note.igst) as igst,\r\n" + 
			" sum(t_material_receipt_note.round_off) as round_off, sum(t_material_receipt_note.bill_amount) as bill_amount\r\n" + 
	...
	@Query(value="select\r\n" + 
			...
			" m_supplier.supp_city, m_supplier.supp_gstin, sum(t_material_receipt_note.basic_value) as basic_value, sum(t_material_receipt_note.disc_amt+t_material_receipt_note.disc_amt2) as disc_amt,\r\n" + 
			...
			" sum(t_material_receipt_note.sgst) as sgst, sum(t_material_receipt_note.igst) as igst, sum(t_material_receipt_note.round_off) as round_off,\r\n" + 
			" sum(t_material_receipt_note.bill_amount) as bill_amount from t_material_receipt_note , m_supplier where \r\n" + 
