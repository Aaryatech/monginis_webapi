...
public interface SpCakeOrdersRepoAdmin extends JpaRepository<SpCakeOrdersBean, Integer> {
	...
	@Query(value="SELECT m_franchisee.fr_name ,m_sp_cake.sp_code ,m_sp_cake.sp_name ,"
			...
			+ "t_sp_cake.sp_id = m_sp_cake.sp_id AND t_sp_cake.fr_id = m_franchisee.fr_id AND m_sp_flavour.spf_id=t_sp_cake.sp_flavour_id ORDER BY t_sp_cake.sp_order_no  "
			,nativeQuery=true)
...
//
	...
	@Query(value="SELECT m_franchisee.fr_name, m_sp_cake_category.sp_code, m_sp_cake_category.sp_name, t_sp_cake.item_id, "
			+ "t_sp_cake.sp_order_no, t_sp_cake.sp_selected_weight, m_sp_flavour.spf_name, t_sp_cake.sp_events, "
