...
public interface InstrumentRepository extends JpaRepository<Instrument, Integer>{
	...
	@Query(value="select i.instrument_id,i.instrument_name,i.instrument_opqty,i.instrument_clqty,i.instrument_is_used,i.instrument_status,i.stock_qty,i.inst_type,i.del_status from m_instrument i,m_type t where t.sub_type=:instType AND i.del_status=:delStatus",nativeQuery=true)
