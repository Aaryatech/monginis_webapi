...
public interface SalesComparisonReportRepo extends JpaRepository<SalesComparisonReport, Integer> {
	...
	@Query(value=" SELECT UUID() as id,MONTH(t_bill_header.bill_date) as month,MONTHNAME(t_bill_header.bill_date) as month_name, m_fr_route.route_name ,m_franchisee.fr_id, m_franchisee.fr_name"
