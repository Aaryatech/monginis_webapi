...
@Query(value="SELECT t_order.order_id ,t_order.fr_id ,t_order.menu_id ,t_order.order_qty ,t_order.item_id from t_order WHERE t_order.order_date =:date AND t_order.fr_id IN(:frId) AND t_order.menu_id =:menuId",nativeQuery=true)
