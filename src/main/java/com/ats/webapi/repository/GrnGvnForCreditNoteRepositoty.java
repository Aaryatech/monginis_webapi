...
public interface GrnGvnForCreditNoteRepositoty extends JpaRepository<GetGrnGvnForCreditNote, Integer>{
	...
	@Query(value = " \n" + 
			"SELECT t_grn_gvn.grn_gvn_id,t_grn_gvn.grn_gvn_header_id,t_grn_gvn_header.grngvn_srno,t_grn_gvn.grn_gvn_entry_datetime,t_grn_gvn.grn_gvn_date,t_grn_gvn.bill_no,t_grn_gvn.fr_id,t_grn_gvn.item_id,t_grn_gvn.item_rate,\n" + 
			...
			"m_item,t_grn_gvn,t_grn_gvn_header,m_sp_cake s WHERE t_grn_gvn.is_grn=:isGrn AND t_grn_gvn.fr_id=m_franchisee.fr_id AND t_grn_gvn.grn_gvn_header_id=t_grn_gvn_header.grn_gvn_header_id AND \n" + 
