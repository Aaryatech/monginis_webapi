...
public interface GetRmItemCatRepository  extends JpaRepository<GetRmItemCategory, Long>{
	...
	@Query(value="select c.cat_Id,c.grp_id,g.grp_name,c.cat_name,c.cat_desc,c.del_status from m_rm_item_cat c,m_rm_item_group g where c.del_status=0 group by c.cat_id",nativeQuery=true)
